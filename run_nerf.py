...
def config_parser():
    ...
    parser.add_argument("--use_rigidmask", type=int, default=1250,
                        help='time of soft mask to rigid mask')
...
def train():
    ...
    start = 0
    # Load Checkpoints
    if args.ft_path is not None and args.ft_path != 'None': # ckp can be loaded from args
        ckpts = [args.ft_path]
    else:
    ...
    for i in range(start, N_iters):
        ...
        rgb, rgb0, extra_loss = nerf(H, W, K, chunk=args.chunk,
                                     use_rigidmask = i > args.use_rigidmask,
